export default [
  ...
  },
  {
    ...
    downloads: [
     ...
     },
	 {
	  ...
	  {
		  title: 'Календарь соревнований Московской области на 2021 г.',
  ...
  },
  {
    ...
    downloads: [
	  ...
	  {
		title: 'Приказ № 919 от 25.10.2017 г. Об утверждении положения о присвоении почетных спортивных званий',
		link: 'https://mo-swimming.ru/static/documents/2021/01/1.Спорт-е звания от 25.10.2017Прик-919.pdf'
	  },
	  {
		title: 'Положение о Единой всероссийской спортивной классификации',
		link: 'https://mo-swimming.ru/static/documents/2021/01/ЕВСК № 143 16.02.18.docx'
	  },
	  {
		title: 'Нормы и условия их выполнения для присвоения спортивных званий и спортивных разрядов',
		link: 'https://mo-swimming.ru/static/documents/2021/01/ЕВСК новая 28 апр.2019.xls'
	  },
	  {
		title: 'Приказ №479 от 01.06.2017 г. О внесение изменений в Положение о Единой всероссийской спортивной классификации',
		link: 'https://mo-swimming.ru/static/documents/2021/01/Изменен отмена книжек судей.pdf'
	  },
	  {
  ...
  {
    title: 'Заявки на соревнования в Федерацию плавания МО',
    downloads: [
      {
  ...
  },
  {
    ...
    downloads: [
      {
        title: 'Устав региональной общественной организации "Федерация плавания Московской области"',
        link: 'http://pushkinoswim.ucoz.ru/DOC/Ustav_FPMO.pdf'
      }
    ]
  },
]